...
INSERT INTO packaging_section (id, state, iddrug, idpackaging_topic, text) VALUES (80,0,12,4,'<h4>Was ist Prednisolon AL 50 mg und wofür wird es angewendet?</h4> <p>Prednisolon AL 50 mg ist ein Glukokortikoid (Nebennierenrindenhormon) mit Wirkung auf den Stoffwechsel, den Salz (Elektrolyt)-Haushalt und auf Gewebefunktionen. Prednisolon AL 50 mg wird angewendet bei Erkrankungen, die eine systemische Behandlung mit Glukokortikoiden notwendig machen. Hierzu gehören je nach Erscheinungsform und Schweregrad (Dosierungstabelle mit den Dosierungen [DS: a bis d und Dosierung e] siehe Abschnitt 3. „Falls vom Arzt nicht anders verordnet, ist die übliche Dosis“): </p>');
